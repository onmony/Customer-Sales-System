...
This document defines the target directory structure for the React application. Strict adherence to this structure ensures predictability and scalability once frontend implementation begins.
...
*   **`routes`**: Maps URLs to specific Workspaces or Layouts. Handles top-level lazy loading. Router: Approved implementation will be selected during Module 9.
...
*   **`theme`**: Design tokens and Tailwind configuration mapping.
