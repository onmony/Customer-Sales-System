...
export interface CustomerRepository {
  ...
  search(tenantId: string, query: string, params?: { skip?: number; take?: number }): Promise<Prisma.CustomerGetPayload<null>[]>;
  findByStatus(tenantId: string, statusId: string, params?: { skip?: number; take?: number }): Promise<Prisma.CustomerGetPayload<null>[]>;
